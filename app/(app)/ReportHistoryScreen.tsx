...
export default function ReportHistoryScreen() {
  ...
  return (
    <View style={[styles.container, { paddingTop: 1 }]}>
      ...
      <Animated.View style={[styles.statsRow, { opacity: fadeAnim, transform: [{ translateY: slideAnim }], paddingTop: SPACING.sm }]}>
...
const styles = StyleSheet.create({
  ...
  statsRow: { flexDirection: "row", paddingHorizontal: SPACING.lg, paddingVertical: SPACING.sm, gap: SPACING.sm },
  ...
  filtersContainer: { paddingHorizontal: SPACING.sm, marginBottom: SPACING.sm },
