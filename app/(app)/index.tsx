...
const Dashboard = () => {
  ...
  // FIXED: Made trend optional by checking if it's defined
  ...
  const RecentReportItem = ({ report }: any) => (
    <TouchableOpacity
      style={styles.recentReportItem}
      onPress={() =>
        router.push({
          pathname: "/(app)/report/ReportReviewScreen",
    ...
    >
      ...
      <View style={styles.reportInfo}>
        ...
        <View style={styles.reportMeta}>
          ...
          <Text style={styles.reportMetaText}>
            {formatCurrency(
              report.districts?.reduce((sum: number, d: any) => sum + (d.offering || 0), 0),
            )}
          </Text>
        </View>
      </View>
        ...
        <View style={styles.statsSection}>
          ...
          <View style={styles.statsGrid}>
            ...
            <StatCard
              ...
              // No trend prop here - it's now optional
            />
          </View>
        </View>
