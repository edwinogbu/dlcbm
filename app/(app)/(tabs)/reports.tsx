...
const FilterChip = ({ label, isActive, onPress, color = COLORS.primary }) => {
...
const SortOption = ({ label, icon, isActive, onPress }) => {
  const scaleAnim = useRef(new Animated.Value(1)).current;
...
const ReportCard = ({ report, onPress, onEdit, onDelete, onExportPress }) => {
  const scaleAnim = useRef(new Animated.Value(1)).current;
...
const PDFPreviewModal = ({ visible, report, onClose, onExport }) => {
...
export default function ReportHistoryScreen() {
  ...
  const handleExportPress = (report) => {
