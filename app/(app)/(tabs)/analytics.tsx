...
interface AnalyticsData {
  ...
  avgAttendancePerReport: number;
  avgOfferingPerReport: number;
  avgDistrictsPerReport: string | number;
  attendanceGrowth: number;
  offeringsGrowth: number;
  visitorsRatio: number;
  topGroups: Array<{ name: string; reports: number; attendance: number; offerings: number }>;
  monthlyTrend: Array<{ month: string; attendance: number; offerings: number; reports: number }>;
}
...
const AnalyticsScreen: React.FC = () => {
  ...
  const analytics: AnalyticsData = useMemo(() => {
    const now = new Date();
    let filteredReports: Report[] = savedReports;
    ...
    const monthlyTrend: Record<string, MonthlyTrend> = {};
  ...
  const TimeRangeButton: React.FC<TimeRangeButtonProps> = ({ label, value, currentRange, onPress }) => (
    <TouchableOpacity
      style={[
        styles.timeRangeButton,
        currentRange === value && styles.timeRangeActive,
      ]}
    ...
    >
      <Text
        style={[
          ...
          currentRange === value && styles.timeRangeTextActive,
        ]}
      >
        {label}
      </Text>
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.timeRangeContainer}>
          <TimeRangeButton label="Week" value="week" currentRange={timeRange} onPress={setTimeRange} />
          <TimeRangeButton label="Month" value="month" currentRange={timeRange} onPress={setTimeRange} />
          <TimeRangeButton label="Year" value="year" currentRange={timeRange} onPress={setTimeRange} />
          <TimeRangeButton label="All" value="all" currentRange={timeRange} onPress={setTimeRange} />
        </View>
...
interface Styles {
  ...
  groupInfo: ViewStyle;
  groupName: TextStyle;
  groupStats: TextStyle;
  groupOffering: TextStyle;
  trendHeader: ViewStyle;
  monthText: TextStyle;
  monthStats: TextStyle;
